...
const ProjectFormDialog: React.FC<ProjectFormDialogProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} safetyClose={true} onClose={onClose} title={mode === 'add' ? 'Add Project' : 'Edit Project'} size="xl">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="border-t border-[var(--border-color)] pt-4">
          <h4 className="font-medium mb-2 text-[var(--sidebar-text)]">Testimonial (Optional)</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-1" style={{ color: 'var(--sidebar-text)' }}>
                Content
            ...
            <div>
              ...
              />
              <label className="block text-sm font-medium mt-2 mb-1" style={{ color: 'var(--sidebar-text)' }}>
                Position
              </label>
              <input
