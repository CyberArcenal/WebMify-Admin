...
const ProjectViewDialog: React.FC<ProjectViewDialogProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "features" | "gallery" | "techstack"
  >("overview");
        ...
        <div className="space-y-4">
          ...
          <div className="border-b border-[var(--border-color)]">
            <nav className="flex gap-4">
              {(["overview", "features", "gallery", "techstack"] as const).map(
                (tab) => (
                  <button
                    key={tab}
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {project.impact_stats.sales_increase && (
                          <div>
                            ...
                            <div className="font-medium text-sm text-[var(--sidebar-text)]">
                              {project.impact_stats.sales_increase}
                            </div>
                          </div>
                        )}
                ...
                {project.tech_stack_details.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {project.tech_stack_details.map((tech, idx) => (
                      <div
                        key={idx}
                        className="bg-[var(--card-secondary-bg)] p-2 rounded-md"
                      >
