// src/pages/projects/components/ProjectActionsDropdown.tsx
...
const ProjectActionsDropdown: React.FC<ProjectActionsDropdownProps> = ({
  ...
  return (
    <div className="project-actions-dropdown-container" ref={dropdownRef}>
      <button
        ref={buttonRef}
        onClick={(e) => {
          e.stopPropagation();
          ...
          <div className="py-1">
            ...
            {project.featured ? (
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleAction(() => onToggleFeatured?.(project));
                }}
                className="w-full flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100"
              >
