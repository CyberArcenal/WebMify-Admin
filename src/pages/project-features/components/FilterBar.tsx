// src/pages/project-features/components/FilterBar.tsx
import React from "react";
import type { ProjectFeatureFilters } from "../hooks/useProjectFeatures";

interface FilterBarProps {
  filters: ProjectFeatureFilters;
  onFilterChange: (key: keyof ProjectFeatureFilters, value: string) => void;
  onReset: () => void;
}
