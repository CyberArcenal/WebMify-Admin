// src/pages/email-templates/components/FilterBar.tsx
import React from "react";
import type { EmailTemplateFilters } from "../hooks/useEmailTemplates";

interface FilterBarProps {
  filters: EmailTemplateFilters;
  onFilterChange: (key: keyof EmailTemplateFilters, value: string) => void;
  onReset: () => void;
}
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <input
          type="text"
          placeholder="Search in name, subject, content..."
