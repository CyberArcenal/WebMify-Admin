// src/pages/email-templates/components/EmailTemplateActionsDropdown.tsx
...
interface EmailTemplateActionsDropdownProps {
...
const EmailTemplateActionsDropdown: React.FC<EmailTemplateActionsDropdownProps> = ({
  template,
  onView,
  onEdit,
  onDelete,
  ...
  return (
    <div className="template-actions-dropdown-container" ref={dropdownRef}>
      <button
        ref={buttonRef}
        onClick={(e) => {
          e.stopPropagation();
...
export default EmailTemplateActionsDropdown;