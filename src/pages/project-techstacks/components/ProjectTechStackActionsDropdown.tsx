// src/pages/project-techstacks/components/ProjectTechStackActionsDropdown.tsx
...
interface ProjectTechStackActionsDropdownProps {
  item: ProjectTechStackWithDetails;
...
const ProjectTechStackActionsDropdown: React.FC<ProjectTechStackActionsDropdownProps> = ({
  item,
  onView,
  onEdit,
  onDelete,
  ...
  return (
    <div className="techstack-actions-dropdown-container" ref={dropdownRef}>
      <button
        ref={buttonRef}
        onClick={(e) => {
          e.stopPropagation();
...
export default ProjectTechStackActionsDropdown;