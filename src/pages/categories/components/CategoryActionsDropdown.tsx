// src/pages/categories/components/CategoryActionsDropdown.tsx
...
const CategoryActionsDropdown: React.FC<CategoryActionsDropdownProps> = ({
  ...
  return (
    <div className="category-actions-dropdown-container" ref={dropdownRef}>
      <button
        ref={buttonRef}
        onClick={(e) => {
          e.stopPropagation();
          ...
          <div className="py-1">
            ...
            {category.featured ? (
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleAction(() => onToggleFeatured?.(category));
                }}
                className="w-full flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100"
              >
            ...
            <button
              onClick={(e) => {
                e.stopPropagation();
                handleAction(() => onDelete(category));
              }}
